...
import { createMockConnector } from "./connector-factory"; import { connectorRegistry } from "./connector-registry"; import { githubConnector } from "./providers/github"; import { vercelConnector } from "./providers/vercel";
const mocks = [
